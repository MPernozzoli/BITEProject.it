...
| `/admin/tracks` | `AdminVoyageTracks.tsx` | tracciati GPX: import, riconciliazione automatica con le tratte, editor manuale, copertura per tratta → [[29 - Tracciati Reali GPX]] |
