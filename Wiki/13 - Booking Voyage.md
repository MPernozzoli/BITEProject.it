...
- **Ripresa dopo login:** il redirect verso `/login` conserva sempre pathname e query string del booking; il login passwordless usa `state.from`/`redirect` gia normalizzati da `UserLogin.tsx`, quindi non perde piu il `voyage` selezionato.
