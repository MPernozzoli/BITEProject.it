...
6. Conferma condizioni e registrazione candidatura. Il messaggio finale dice che la candidatura è stata registrata e verrà esaminata al più presto.
7. Creazione richiesta via RPC `request_voyage_booking`, con `candidate_info` salvato sulla richiesta e stato iniziale `requested` → [[08 - Supabase]].
8. Dopo approvazione admin/conferma utente si passa al contributo Bunq o bonifico → [[11 - Pagamenti Bunq]].
