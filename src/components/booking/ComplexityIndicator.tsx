    ...
    <span ref={rootRef} className={`relative inline-flex items-center gap-1 ${className}`}>
      ...
      {open && (
        <span
          role="tooltip"
          id={tooltipId}
          className="absolute bottom-full left-1/2 z-50 mb-1.5 w-[min(280px,78vw)] -translate-x-1/2 rounded-xl border border-border/70 bg-popover/95 p-3 text-left text-[11px] font-normal leading-relaxed text-popover-foreground shadow-xl backdrop-blur"
        >
