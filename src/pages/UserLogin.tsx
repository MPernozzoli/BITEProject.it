...
import { ArrowLeft, Compass, MessageCircle, ShieldCheck, Sparkles, UserPlus } from "lucide-react";
    ...
    <div className="relative isolate overflow-hidden px-6 pb-24 pt-24 sm:px-8 lg:px-12">
      ...
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
        <section className="space-y-8 slide-up">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/70 bg-white/60 px-4 py-2 text-[0.68rem] font-semibold uppercase tracking-[0.28em] text-muted-foreground shadow-[0_18px_40px_-28px_hsl(var(--navy)/0.45)] backdrop-blur">
            <Sparkles className="h-3.5 w-3.5 text-accent" />
            <span>{ui.hero.badge}</span>
          </div>

          <div className="space-y-4">
            <p className="font-sans text-[0.72rem] uppercase tracking-[0.32em] text-muted-foreground">
              {ui.hero.kicker}
            </p>
        ...
        <section className="fade-in">
          <div className="rounded-[2rem] border border-white/70 bg-[linear-gradient(180deg,_rgba(255,255,255,0.86)_0%,_rgba(255,255,255,0.72)_100%)] p-6 shadow-[0_36px_90px_-48px_hsl(var(--navy)/0.55)] backdrop-blur md:p-8">
            <div className="space-y-6">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 rounded-full bg-[hsl(var(--secondary)/0.88)] px-3 py-1 text-[0.65rem] font-semibold uppercase tracking-[0.28em] text-muted-foreground">
                  <ShieldCheck className="h-3.5 w-3.5 text-accent" />
                  <span>{ui.form.badge}</span>
                </div>
                ...
                <form onSubmit={handleSendOtp} className="space-y-5">
                  ...
                  <div className="relative py-2">
                    ...
                    <div className="relative flex justify-center">
                      <span className="rounded-full bg-[hsl(var(--background)/0.92)] px-3 text-[0.68rem] font-semibold uppercase tracking-[0.28em] text-muted-foreground">
                        {ui.form.divider}
                      </span>
                    </div>
                  </div>
                  ...
                  <Button
                    ...
                    disabled={loading}
                    className="h-12 w-full rounded-full border-white/85 bg-white/72 px-6 text-sm font-semibold shadow-[0_20px_44px_-34px_hsl(var(--navy)/0.4)] hover:bg-white"
                  >
