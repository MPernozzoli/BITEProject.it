    ...
    <div className="space-y-5 pb-4 md:space-y-6 md:pb-6">
      ...
      <section className="page-section pt-0">
        <div className="page-section-narrow glass-panel-dark rounded-[38px] px-6 py-10 text-center text-white md:px-10 md:py-12">
          <div className="glass-chip-dark inline-flex h-14 w-14 items-center justify-center mb-6 text-white/78">
            <Music size={20} />
          </div>
          ...
          <p className="text-xs font-sans tracking-[0.2em] uppercase text-white/46 mb-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="glass-button-dark inline-flex items-center gap-2 px-5 py-2.5 text-xs font-sans tracking-wide"
            >
      ...
      <section className="page-section pt-0">
        <div className="page-section-wide glass-panel-dark rounded-[38px] px-6 py-10 text-white md:px-10 md:py-12">
          <div className="page-section-narrow text-center mb-10">
            ...
            <p className="text-xs font-sans tracking-[0.3em] uppercase text-white/42 mb-4">
