...
const translations: Translations = {
  ...
  "crew.freya.title": { en: "Freyja", it: "Freyja" },
  "crew.freya.text": { en: "An Alaskan Malamute who joined the crew at one year old after Snow Daisy's passing. Until then, she had lived her whole life in the breeder's enclosure and knew nothing of the outside world — a true scaredy-cat. Discovering the world past the age of one is hard for a dog, but watching Godot face it fearlessly gave her confidence and courage. Now she's become fearless herself — sometimes too much so, as long as Godot is nearby.", it: "Un'Alaskan Malamute arrivata nella ciurma all'età di un anno dopo la morte di Snow Daisy. Fino a quel momento aveva vissuto nel recinto dell'allevamento e non conosceva niente del mondo circostante — una vera fifona. Scoprire il mondo a più di un anno per un cane può essere molto difficile, ma vedere come Godot lo affrontava in maniera temeraria le ha dato fiducia e coraggio. Ora è diventata impavida, anche troppo — finché ha Godot vicino!" },
