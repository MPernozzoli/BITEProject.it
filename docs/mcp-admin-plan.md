...
| 1 · Trasporto, auth token, audit | ✅ | `api/mcp/index.ts`, `api/mcp/tokens.ts`, `src/server/mcp/{auth,audit,registry,context}.ts`, migrazione `20260802210739` |
...
| 6 · OAuth 2.1 | ✅ | `api/mcp/oauth/*`, `src/server/mcp/oauth.ts`, `AdminMcpAuthorize.tsx`, migrazione `20260802213214` |
