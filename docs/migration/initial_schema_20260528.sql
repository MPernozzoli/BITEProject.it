...
create table if not exists public.email_notification_preferences (
  ...
  push_mail_enabled boolean not null default true,
  push_voyage_admin_enabled boolean not null default true,
  push_voyage_user_enabled boolean not null default true,
