...
interface ArticleSlidePanelProps {
  ...
  /** Etichetta posizione (es. waypoint di partenza se articolo su un leg). */
...
const ArticleSlidePanel = ({
  ...
  const pinLabel =
    (locationLabel != null && locationLabel.trim()) ||
    article.location_name?.trim() ||
    (lang === "it" ? "Anteprima articolo" : "Article preview");
