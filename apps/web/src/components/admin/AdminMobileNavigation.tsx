...
const AdminMobileNavigation = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-md rounded-[28px] border border-glass-edge/70 bg-background/90 shadow-[0_18px_55px_rgba(15,23,42,0.18)] backdrop-blur-2xl">
              ...
              <NavLink
                ...
                className={cn(
                  ...
                  active
                    ...
                    : "text-muted-foreground hover:bg-glass/70 hover:text-foreground",
                )}
              >
