    ...
    <div className="min-h-screen pt-24 pb-16 px-6 md:px-12">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <section className="glass-panel rounded-[34px] p-5 md:p-6 lg:p-8">
          <Suspense fallback={<div className="glass-panel-soft rounded-[28px] p-8 text-muted-foreground">Caricamento piano editoriale…</div>}>
            <AdminEditorialPlan />
          </Suspense>
        </section>
      </div>
...
export default AdminEditorialPlanPage;
