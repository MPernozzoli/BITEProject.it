...
import { Search, Plus, Map, List, ChevronUp, ChevronDown, ChevronLeft, ChevronRight } from "lucide-react";
...
import JournalMapStatsBar from "@/components/JournalMapStatsBar";
      ...
      {viewMode === "map" ? (
        <div className={mapInnerClass}>
          ...
          <JournalMapStatsBar
            ...
            voyageTypeFilter={voyageTypeFilter}
            setVoyageTypeFilter={setVoyageTypeFilter}
            voyageFilterOpen={voyageFilterOpen}
            setVoyageFilterOpen={setVoyageFilterOpen}
            focusedVoyageId={focusedVoyageId}
            handleVoyageFilterSelect={handleVoyageFilterSelect}
            lang={lang}
          />
