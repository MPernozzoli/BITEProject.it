-- RICOSTRUZIONE (2026-09-23). Versione registrata sul remoto fuori banda (MCP apply_migration)
-- senza file nel repo: e la seconda applicazione di 20260917120000_voyage_planned_vs_actual_stops.sql,
-- modificato dopo la prima applicazione. Il corpo qui sotto e byte-identico alle statement registrate
-- in supabase_migrations.schema_migrations per la versione 20260917203938 (md5 d1b9ca4c...).
-- Lavoro originale della sessione che ha introdotto actual_status sui waypoint.
